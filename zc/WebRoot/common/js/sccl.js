	...
	for(var i=0; i<menu.length; i++){   
		...
		try{
			if(item.isHeader == "1"){
				...
				if(item.childMenus == ""){
					str = "<li><a href='"+item.url+"' class='chen'><i class='icon-font'>"+item.icon+"</i><span>"+item.name+"</span></a></li>";
					$(parent).append(str);
				}else{
...
$(function(){
	...
	var menu = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
					{"id":"3","name":"在线反馈","parentId":"1","url":"","icon":"&#xe606;","order":"1","isHeader":"0","childMenus":[
						{"id":"4","name":"未解决","parentId":"3","url":"feedBack.jsp?state=0","icon":" ","order":"1","isHeader":"0","childMenus":""},
						{"id":"5","name":"已解决","parentId":"3","url":"feedBack.jsp?state=1","icon":" ","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"6","name":"订单管理","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
						{"id":"7","name":"已付款","parentId":"6","url":"orderManager.jsp?state=1","icon":" ","order":"1","isHeader":"0","childMenus":""},
						{"id":"8","name":"未付款","parentId":"6","url":"orderManager.jsp?state=0","icon":" ","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"9","name":"信息查询","parentId":"1","url":"searchInfo.jsp","icon":"&#xe603;","order":"1","isHeader":"0","childMenus":""},
					{"id":"10","name":"测试结果查询","parentId":"1","url":"testResult.jsp","icon":"&#xe607;","order":"1","isHeader":"0","childMenus":""},
					{"id":"11","name":"下载安装包","parentId":"1","url":"downloadApp.jsp","icon":"&#xe610;","order":"1","isHeader":"0","childMenus":""},
					{"id":"25","name":"消息推送","parentId":"1","url":"messagePush.jsp","icon":"&#xe603;","order":"1","isHeader":"0","childMenus":""}
				]}				
				];
