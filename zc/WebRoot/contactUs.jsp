...
<div class="chen-contact">
    ...
    <div class="contact-way">
        <div class="container">
            <div class="us">
                <h3>CONTACT US<i>联系我们</i></h3>
                <p>如有任何问题，欢迎以如下方式联系我们，TEST满足您的一切需求</p>
            </div>
            <div class="address clearfix">
                <div class="left">
                    <h3>深圳总部</h3>
                    <p>电 话：0755-86313688</p>
                    <p>网址：www.expdatacloud.com/test</p>
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=5WiZFCkapsss5Qr8ejTCqo9PaebDGnlW"></script>
