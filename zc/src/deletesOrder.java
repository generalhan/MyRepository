...
public class deletesOrder extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String mess2=orderMess.deleteOrder2(orderID);
		String mess=orderMess.deleteOrder(orderID);
		orderMess.close();
		if("1".equals(mess) && "1".equals(mess2)){
